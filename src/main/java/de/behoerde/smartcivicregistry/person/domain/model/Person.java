...
public class Person extends AuditableEntity {
    ...
    public int calculateAge() {
        if (dateOfBirth == null) {
            throw new IllegalStateException("Geburtsdatum ist nicht gesetzt");
        }
    ...
    public String getFullName() {
        ...
        fullName.append(" ").append(lastName != null ? lastName.trim() : "");
    ...
    public boolean isGermanAddress() {
        ...
        return "de".equals(countryLower) ||
                "deutschland".equals(countryLower) ||
                "germany".equals(countryLower);
    }
    ...
    public static class PersonBuilder {
        ...
        public PersonBuilder nationalIdNumber(String nationalIdNumber) {
            this.nationalIdNumber = nationalIdNumber;
            return this;
        }

        public PersonBuilder taxId(String taxId) {
            this.taxId = taxId;
            return this;
        }
        ...
        public PersonBuilder createdAt(LocalDateTime createdAt) {
            this.createdAt = createdAt;
            return this;
        }

        public PersonBuilder updatedAt(LocalDateTime updatedAt) {
            this.updatedAt = updatedAt;
            return this;
        }

        public PersonBuilder createdBy(String createdBy) {
            this.createdBy = createdBy;
            return this;
        }

        public PersonBuilder updatedBy(String updatedBy) {
        ...
        public Person build() {
            ...
            if (firstName == null || firstName.trim().isEmpty()) {
                throw new IllegalStateException("firstName darf nicht null oder leer sein");
            }
            if (lastName == null || lastName.trim().isEmpty()) {
                throw new IllegalStateException("lastName darf nicht null oder leer sein");
            }
            if (dateOfBirth == null) {
                throw new IllegalStateException("dateOfBirth darf nicht null sein");
            }
            if (dateOfBirth.isAfter(LocalDate.now())) {
                throw new IllegalStateException("dateOfBirth darf nicht in der Zukunft liegen");
            }
            ...
            person.setFirstName(this.firstName.trim());
            person.setLastName(this.lastName.trim());
            person.setDateOfBirth(this.dateOfBirth);

            // Optionale Felder (trimmen falls vorhanden)
            person.setTitle(this.title != null ? this.title.trim() : null);
            person.setMiddleName(this.middleName != null ? this.middleName.trim() : null);
            person.setMaidenName(this.maidenName != null ? this.maidenName.trim() : null);
            person.setGender(this.gender);
            person.setCitizenship(this.citizenship != null ? this.citizenship.trim() : null);
            person.setStreet(this.street != null ? this.street.trim() : null);
            person.setHouseNumber(this.houseNumber != null ? this.houseNumber.trim() : null);
            person.setPostalCode(this.postalCode != null ? this.postalCode.trim() : null);
            person.setCity(this.city != null ? this.city.trim() : null);
            person.setCountry(this.country != null ? this.country.trim() : null);
            person.setEmail(this.email != null ? this.email.trim() : null);
            person.setPhone(this.phone != null ? this.phone.trim() : null);
            person.setMobilePhone(this.mobilePhone != null ? this.mobilePhone.trim() : null);
            person.setMaritalStatus(this.maritalStatus);
            person.setBirthPlace(this.birthPlace != null ? this.birthPlace.trim() : null);
            person.setNationalIdNumber(this.nationalIdNumber != null ? this.nationalIdNumber.trim() : null);
            person.setTaxId(this.taxId != null ? this.taxId.trim() : null);

            // AuditableEntity Felder
            person.setCreatedAt(this.createdAt);
            person.setUpdatedAt(this.updatedAt);
            person.setCreatedBy(this.createdBy);
            person.setUpdatedBy(this.updatedBy);
            person.setDeleted(this.deleted);
    ...
    /**
     * Erstellt einen neuen Builder mit den Werten der aktuellen Person.
     * Nützlich für unveränderliche Updates.
     *
     * @return Builder mit aktuellen Werten
     */
    ...
    // ==================== OBJECT METHODEN (vereinfacht mit Lombok) ====================

    /**
     * Vergleicht diese Person mit einem anderen Objekt auf Gleichheit.
     * Gleichheit basiert auf ID, E-Mail oder Personalausweisnummer.
     */
    @Override
    public boolean equals(Object o) {
        ...
        // Priorität 2: E-Mail (eindeutig)
        if (email != null && person.email != null) {
            return email.equals(person.email);
        }
        // Priorität 3: Personalausweisnummer (eindeutig)
    ...
    public String toString() {
        return String.format("Person{id=%d, fullName='%s', email='%s', dateOfBirth=%s, deleted=%s}",
                id, getFullName(), email, dateOfBirth, isDeleted());
    }
}
